...
setMethod("predict",
          ...
          function(object, newdata) {
            ...
            Y_hat_recent <- predict(object@base_ensemble, object@recent_series, use_all=TRUE)
            ...
            E_hat <-
              lapply(object@meta_model,
                     function(o) {
                       meta_predict(o, newdata, object@meta_model_type) # remove ind.day and ind.seq from here !
                     })
...
setMethod("predict",
          ...
          function(object, newdata, use_all=FALSE) {
